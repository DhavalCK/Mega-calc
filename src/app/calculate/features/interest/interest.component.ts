...
export class InterestComponent implements OnInit, OnDestroy{
  ...
  setBreakdownOptions() {
    ...
    const option1 = this.timePeriodOptions.find((el: any) => this.interestRateTimePeriod === el.value);
    const option2 = this.timePeriodOptions.find((el: any) => this.timePeriod === el.value);
